...
function Supporters_insert(&$error_message = '') {
	...
	$data = [
		...
		'ContactMethod' => Request::val('ContactMethod', ''),
	];
...
function Supporters_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $separateDV = 0, $TemplateDV = '', $TemplateDVP = '') {
	...
	$combo_ContactMethod->ListType = 0;
	...
	if($selected_id) {
		...
		$combo_State->SelectedText = (isset($filterField[1]) && $filterField[1] == '8' && $filterOperator[1] == '<=>' ? $filterValue[1] : '');
		$combo_Country->SelectedText = (isset($filterField[1]) && $filterField[1] == '10' && $filterOperator[1] == '<=>' ? $filterValue[1] : 'United States');
		$combo_Status->SelectedText = (isset($filterField[1]) && $filterField[1] == '14' && $filterOperator[1] == '<=>' ? $filterValue[1] : 'Active');
		$combo_ContactMethod->SelectedText = (isset($filterField[1]) && $filterField[1] == '15' && $filterOperator[1] == '<=>' ? $filterValue[1] : '');
	}
	$combo_State->Render();
	...
	if($dvprint) {
		$template_file = is_file("./{$TemplateDVP}") ? "./{$TemplateDVP}" : './templates/Supporters_templateDVP.html';
