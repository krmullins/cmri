	...
	$lookups = [
		...
		'Donations' => [
			'SupporterID' => [
				...
				'parent_pk_field' => 'ID',
				'parent_caption' => 'IF(CHAR_LENGTH(`Supporters`.`LastName`) || CHAR_LENGTH(`Supporters`.`Name`), CONCAT_WS(\'\', `Supporters`.`LastName`, \', \', `Supporters`.`Name`), \'\')',
		...
		'MatchingFunds' => [
			...
			'DonationID' => [
				...
				'parent_pk_field' => 'ID',
				'parent_caption' => 'IF(CHAR_LENGTH(if(`Donations`.`DateLink`,date_format(`Donations`.`DateLink`,\'%m/%d/%Y\'),\'\')) || CHAR_LENGTH(`Donations`.`Amount`), CONCAT_WS(\'\', if(`Donations`.`DateLink`,date_format(`Donations`.`DateLink`,\'%m/%d/%Y\'),\'\'), \' - \', `Donations`.`Amount`), \'\')',
