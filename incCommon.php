<?php
	...
	*/
	...
	function get_sql_fields($table_name) {
		$sql_fields = [
			'Supporters' => "`Supporters`.`ID` as 'ID', `Supporters`.`FirstName` as 'FirstName', `Supporters`.`LastName` as 'LastName', `Supporters`.`SpouseName` as 'SpouseName', `Supporters`.`Address1` as 'Address1', `Supporters`.`Address2` as 'Address2', `Supporters`.`City` as 'City', `Supporters`.`State` as 'State', `Supporters`.`Zip` as 'Zip', `Supporters`.`Country` as 'Country', CONCAT_WS('-', LEFT(`Supporters`.`Phone`,3), MID(`Supporters`.`Phone`,4,3), RIGHT(`Supporters`.`Phone`,4)) as 'Phone', CONCAT_WS('-', LEFT(`Supporters`.`Cell`,3), MID(`Supporters`.`Cell`,4,3), RIGHT(`Supporters`.`Cell`,4)) as 'Cell', `Supporters`.`Email` as 'Email', `Supporters`.`Status` as 'Status', `Supporters`.`ContactMethod` as 'ContactMethod', `Supporters`.`TotalDonated` as 'TotalDonated', `Supporters`.`TotalMatched` as 'TotalMatched', `Supporters`.`Name` as 'Name'",
			...
			'Donations' => "`Donations`.`ID` as 'ID', DATE_FORMAT(`Donations`.`Date`, '%h:%i %p') as 'Date', CONCAT('$', FORMAT(`Donations`.`Amount`, 2)) as 'Amount', `Donations`.`Description` as 'Description', IF(    CHAR_LENGTH(`Supporters1`.`LastName`) || CHAR_LENGTH(`Supporters1`.`Name`), CONCAT_WS('',   `Supporters1`.`LastName`, ', ', `Supporters1`.`Name`), '') as 'SupporterID', IF(    CHAR_LENGTH(`Campaigns1`.`CampaignName`), CONCAT_WS('',   `Campaigns1`.`CampaignName`), '') as 'CampaignID', `Donations`.`Paytype` as 'Paytype', `Donations`.`Matching` as 'Matching', `Donations`.`Anonymous` as 'Anonymous', `Donations`.`Acknowledged` as 'Acknowledged', `Donations`.`Notes` as 'Notes', if(`Donations`.`DateLink`,date_format(`Donations`.`DateLink`,'%m/%d/%Y'),'') as 'DateLink', `Donations`.`MemoryOf` as 'MemoryOf', `Donations`.`HonorOf` as 'HonorOf'",
			'Notes' => "`Notes`.`ID` as 'ID', IF(    CHAR_LENGTH(`Supporters1`.`LastName`) || CHAR_LENGTH(`Supporters1`.`Name`), CONCAT_WS('',   `Supporters1`.`LastName`, ', ', `Supporters1`.`Name`), '') as 'SupporterID', DATE_FORMAT(`Notes`.`Date`, '%h:%i %p') as 'Date', `Notes`.`Note` as 'Note'",
			'MatchingFunds' => "`MatchingFunds`.`ID` as 'ID', `MatchingFunds`.`OrganizationName` as 'OrganizationName', CONCAT('$', FORMAT(`MatchingFunds`.`Amount`, 2)) as 'Amount', IF(    CHAR_LENGTH(`Supporters1`.`LastName`) || CHAR_LENGTH(`Supporters1`.`Name`), CONCAT_WS('',   `Supporters1`.`LastName`, ', ', `Supporters1`.`Name`), '') as 'SupporterID', DATE_FORMAT(`MatchingFunds`.`DateSubmitted`, '%h:%i %p') as 'DateSubmitted', DATE_FORMAT(`MatchingFunds`.`DateReceived`, '%h:%i %p') as 'DateReceived', `MatchingFunds`.`Notes` as 'Notes', IF(    CHAR_LENGTH(if(`Donations1`.`DateLink`,date_format(`Donations1`.`DateLink`,'%m/%d/%Y'),'')) || CHAR_LENGTH(`Donations1`.`Amount`), CONCAT_WS('',   if(`Donations1`.`DateLink`,date_format(`Donations1`.`DateLink`,'%m/%d/%Y'),''), ' - ', `Donations1`.`Amount`), '') as 'DonationID', `MatchingFunds`.`Attachment` as 'Attachment'",
		];
...
EOT;
	...
	function getLookupFields($skipPermissions = false, $filterByPermission = 'view') {
		$pcConfig = [
			...
			'Donations' => [
				'SupporterID' => [
					'parent-table' => 'Supporters',
					'parent-primary-key' => 'ID',
					'child-primary-key' => 'ID',
					'child-primary-key-index' => 0,
					'tab-label' => 'Donations <span class="hidden child-label-Donations child-field-caption">(Supporter)</span>',
					'auto-close' => true,
					'table-icon' => 'resources/table_icons/32Px - 385.png',
					'display-refresh' => true,
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [1 => 'Date', 2 => 'Amount', 3 => 'Description', 4 => 'Supporter', 5 => 'Campaign', 6 => 'Payment Type', 7 => 'Matching', 8 => 'Anonymous', 9 => 'Acknowledged', 10 => 'Notes'],
					'display-field-names' => [1 => 'Date', 2 => 'Amount', 3 => 'Description', 4 => 'SupporterID', 5 => 'CampaignID', 6 => 'Paytype', 7 => 'Matching', 8 => 'Anonymous', 9 => 'Acknowledged', 10 => 'Notes'],
					'sortable-fields' => [0 => '`Donations`.`ID`', 1 => '`Donations`.`Date`', 2 => '`Donations`.`Amount`', 3 => 4, 4 => 5, 5 => '`Campaigns1`.`CampaignName`', 6 => 7, 7 => '`Donations`.`Matching`', 8 => '`Donations`.`Anonymous`', 9 => '`Donations`.`Acknowledged`', 10 => 11, 11 => '`Donations`.`DateLink`', 12 => 13, 13 => 14],
					'records-per-page' => 10,
					...
					'query' => "SELECT `Donations`.`ID` as 'ID', DATE_FORMAT(`Donations`.`Date`, '%h:%i %p') as 'Date', CONCAT('$', FORMAT(`Donations`.`Amount`, 2)) as 'Amount', `Donations`.`Description` as 'Description', IF(    CHAR_LENGTH(`Supporters1`.`LastName`) || CHAR_LENGTH(`Supporters1`.`Name`), CONCAT_WS('',   `Supporters1`.`LastName`, ', ', `Supporters1`.`Name`), '') as 'SupporterID', IF(    CHAR_LENGTH(`Campaigns1`.`CampaignName`), CONCAT_WS('',   `Campaigns1`.`CampaignName`), '') as 'CampaignID', `Donations`.`Paytype` as 'Paytype', concat('<i class=\"glyphicon glyphicon-', if(`Donations`.`Matching`, 'check', 'unchecked'), '\"></i>') as 'Matching', concat('<i class=\"glyphicon glyphicon-', if(`Donations`.`Anonymous`, 'check', 'unchecked'), '\"></i>') as 'Anonymous', concat('<i class=\"glyphicon glyphicon-', if(`Donations`.`Acknowledged`, 'check', 'unchecked'), '\"></i>') as 'Acknowledged', `Donations`.`Notes` as 'Notes', if(`Donations`.`DateLink`,date_format(`Donations`.`DateLink`,'%m/%d/%Y'),'') as 'DateLink', `Donations`.`MemoryOf` as 'MemoryOf', `Donations`.`HonorOf` as 'HonorOf' FROM `Donations` LEFT JOIN `Supporters` as Supporters1 ON `Supporters1`.`ID`=`Donations`.`SupporterID` LEFT JOIN `Campaigns` as Campaigns1 ON `Campaigns1`.`ID`=`Donations`.`CampaignID` "
				],
				'CampaignID' => [
					...
					'child-primary-key' => 'ID',
					'child-primary-key-index' => 0,
					'tab-label' => 'Donations <span class="hidden child-label-Donations child-field-caption">(Campaign)</span>',
					'auto-close' => true,
					'table-icon' => 'resources/table_icons/32Px - 385.png',
					'display-refresh' => true,
					'display-add-new' => true,
			...
			'Notes' => [
				'SupporterID' => [
					...
					'child-primary-key' => 'ID',
					'child-primary-key-index' => 0,
					'tab-label' => 'Notes <span class="hidden child-label-Notes child-field-caption">(Supporter Name)</span>',
					'auto-close' => true,
					'table-icon' => 'resources/table_icons/32Px - 125.png',
					'display-refresh' => true,
					'display-add-new' => true,
					'forced-where' => '',
					...
					'query' => "SELECT `Notes`.`ID` as 'ID', IF(    CHAR_LENGTH(`Supporters1`.`LastName`) || CHAR_LENGTH(`Supporters1`.`Name`), CONCAT_WS('',   `Supporters1`.`LastName`, ', ', `Supporters1`.`Name`), '') as 'SupporterID', DATE_FORMAT(`Notes`.`Date`, '%h:%i %p') as 'Date', `Notes`.`Note` as 'Note' FROM `Notes` LEFT JOIN `Supporters` as Supporters1 ON `Supporters1`.`ID`=`Notes`.`SupporterID` "
				],
			],
			'MatchingFunds' => [
				'SupporterID' => [
					...
					'child-primary-key' => 'ID',
					'child-primary-key-index' => 0,
					'tab-label' => 'Matching Funds <span class="hidden child-label-MatchingFunds child-field-caption">(SupporterID)</span>',
					'auto-close' => true,
					'table-icon' => 'resources/table_icons/32Px - 396.png',
					'display-refresh' => true,
					'display-add-new' => true,
					'forced-where' => '',
					'display-fields' => [1 => 'Organization Name', 2 => 'Amount', 3 => 'SupporterID', 4 => 'Date Submitted', 5 => 'Date Received', 6 => 'Notes', 7 => 'DonationID', 8 => 'Attachment'],
					'display-field-names' => [1 => 'OrganizationName', 2 => 'Amount', 3 => 'SupporterID', 4 => 'DateSubmitted', 5 => 'DateReceived', 6 => 'Notes', 7 => 'DonationID', 8 => 'Attachment'],
					'sortable-fields' => [0 => '`MatchingFunds`.`ID`', 1 => 2, 2 => '`MatchingFunds`.`Amount`', 3 => 4, 4 => '`MatchingFunds`.`DateSubmitted`', 5 => '`MatchingFunds`.`DateReceived`', 6 => 7, 7 => 8, 8 => 9],
					'records-per-page' => 10,
					'default-sort-by' => false,
					'default-sort-direction' => 'asc',
					'open-detail-view-on-click' => true,
					'display-page-selector' => true,
					'show-page-progress' => true,
					'template' => 'children-MatchingFunds',
				...
				'DonationID' => [
					'parent-table' => 'Donations',
					'parent-primary-key' => 'ID',
					'child-primary-key' => 'ID',
					'child-primary-key-index' => 0,
					'tab-label' => 'Matching Funds <span class="hidden child-label-MatchingFunds child-field-caption">(DonationID)</span>',
					'auto-close' => true,
					'table-icon' => 'resources/table_icons/32Px - 396.png',
					'display-refresh' => true,
					'display-add-new' => true,
